(function () {
    ...
    function searchLOs() {
        var x = document.getElementById("loSearchBar");
        document.getElementById("myCatalogLogo").innerHTML = "Search Results";
        prime.makeApiCall('GET', "/search?query=" + x.value + "&autoCompleteMode=true&include=model.enrollment&include=model.instances&include=model.skills", function (response) {
            ...
            if (data.length > 0) {
                ...
                for (var ii = 0; ii < data.length; ii++) {
                    ...
                    if (false) {
                        html += '<div id=' + group2Id + '><div class="row"><div class="media col-9"><img class="mr-3" src=' + imageUrl + ' alt="thumbnail" width="64px" height="64px"><div class="media-body"><div class="mt-0 mb-1 course_title">' + data[ii].name + '</div>' + desc + '</div></div><div class="col-3" style="text-align: right;padding:0px;padding-right:10px"><button type="button" class="btn btn-primary buttonStyle-mobile" id=' + buttonId + '>Play</button></div><div class="col-1"></div></div><div class="row"><div class="col-8" id=' + skill + '>Skills : </div><div class="col-4" style="text-align:right" id=' + dateId + '>Due Date : </div><div class="col-1"></div></div><div class="row justify-content-center"><iframe allowfullscreen style="display: none; width: 100%; height: 484px" id=' + playerId + '></i<div class="col-12" style="padding:15px">frame></div></div><div class="row"><div class="col-12 dropdown-divider" style="border-top:1px solid #444444;opacity:0.2;padding:10px"></div></div></div>';
                    } else {
                        html += '<div id=' + group2Id + '><div class="row"><div class="media col-9"><img class="mr-3" src=' + imageUrl + ' alt="thumbnail" width="64px" height="64px"><div class="media-body"><div class="mt-0 mb-1 course_title">' + data[ii].name + '</div>' + desc + '</div></div><div class="col-3" style="text-align: right"><button type="button" class="btn btn-primary buttonStyle-mobile" id=' + buttonId + '>Play</button></div><div class="col-1"></div></div><div class="row"><div class="col-8" id=' + skill + '>Skills : </div><div class="col-4" style="text-align:right" id=' + dateId + '>Due Date : </div><div class="col-1"></div></div><div class="row justify-content-center"><div class="col-12" style="padding:15px;"><iframe allowfullscreen style="display: none; width: 100%; height: 484px" id=' + playerId + '></iframe></div></div><div class="row"><div class="col-12 dropdown-divider" style="border-top:1px solid #444444;opacity:0.2;padding:10px"></div></div></div>';
                    }
    ...
    function getLoList() {
        document.getElementById("myCatalogLogo").innerHTML = "Catalog";
        prime.makeApiCall('GET', "/learningObjects?page[limit]=10&filter.loTypes=course&sort=name&include=enrollment&include=instances&include=skills", function (response) {
            var data = prime.parse(response)['data'];
            ...
            for (var ii = 0; ii < data.length; ii++) {
                ...
                html += '<div id=' + group2Id + '><div class="row"><div class="media col-9"><img class="mr-3" src=' + imageUrl + ' alt="thumbnail" width="64px" height="64px"><div class="media-body"><div class="mt-0 mb-1 course_title">' + data[ii].localizedMetadata[0].name + '</div>' + desc + '</div></div><div class="col-3" style="padding:0px;padding-right:10px;text-align:right"><button type="button" class="btn btn-primary buttonStyle-mobile" id=' + buttonId + '>Play</button></div></div></div><div class="row"><div class="col-8 skilllabel" id=' + skill + '>Skills : </div><div class="col-4 skilllabel" style="text-align:right" id=' + dateId + '>Due Date : </div><div class="col-1"></div></div><div class="row justify-content-center"><div class="col-12"><iframe allowfullscreen style="display: none; width: 100%; height: 484px" id=' + playerId + '></iframe></div></div><div class="row justify-content-center" style="padding:15px"><div class="col-12 dropdown-divider" style="border-top:1px solid #444444;opacity:0.2;padding:10px"></div></div></div>';
            }
            html += "</ul>";
            document.getElementById("loList").innerHTML = html;
            var enrollmentData;
    ...
    function playCourse(courseId) {
        ...
        if (detectMob())
            document.getElementById(playerId).setAttribute('style', 'display: block;z-index: 1001; background: lightgrey; width: 100%; height: 275px;padding-top:15px;');
        else

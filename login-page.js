(function () {
    ...
    var accId = 37949;
    var isLocal = true; //set this flag when working locally
    var linkedinRedirectURI = '';
    if (isLocal == true)
        linkedinRedirectURI = 'http://localhost:8080/home.html';
    else
        linkedinRedirectURI = 'https://s3.amazonaws.com/hosted_data/LinkedInPOC/linkedin-learner-exp2/home.html'; //hosted URL goes here
    ...
    if (redirectParameter == 'mylearning') {
        if (isLocal)
            ...
            linkedinRedirectURI = 'https://s3.amazonaws.com/hosted_data/LinkedInPOC/linkedin-learner-exp2/my-learning.html'
    } else if (redirectParameter == 'myCatalog') {
        if (isLocal)
            linkedinRedirectURI = 'http://localhost:8080/my-catalog.html';
        else
            linkedinRedirectURI = 'https://s3.amazonaws.com/hosted_data/LinkedInPOC/linkedin-learner-exp2/my-catalog.html'
    }
